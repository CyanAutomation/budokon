...
This review covers every record migrated from the legacy `judoka.json`. It was completed on 2026-08-14. `signatureMoveId`, stats, and rarity are shared editorial attributes rather than claims of an official athlete record.
...
| --- | --- | --- | --- | --- |
| Askley McKenzie | Corrected to **Ashley McKenzie**; old slug retained as an alias. | Jamaica (`JM`), men's -60 kg, reflecting his current sporting representation and established division. | `seoi-nage` retained as an editorial characterization. | [Ashley McKenzie](https://en.wikipedia.org/wiki/Ashley_McKenzie); real and visible. |
| Ilia Sulamanidize | Corrected to **Ilia Sulamanidze**; old slug retained as an alias. | Georgia (`GE`), men's -100 kg. | `uchi-mata` retained as an editorial characterization. | [Ilia Sulamanidze](https://en.wikipedia.org/wiki/Ilia_Sulamanidze); real and visible. |
...
| Shōzō Fujii | Diacritics and canonical ASCII slug confirmed. | Japan (`JP`), men's -81 kg as the modern catalogue mapping for his historical divisions. | `seoi-nage` retained as an editorial characterization. | [Shōzō Fujii](https://en.wikipedia.org/wiki/Sh%C5%8Dz%C5%8D_Fujii); real and visible. |
